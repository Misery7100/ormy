...
A = TypeVar("A", bound="ArangoBase")

# ----------------------- #


class ArangoBase(DocumentSingleABC):
    """ArangoDB base class"""
    ...
    @classmethod
    def _get_collection(cls: Type[A]):
        """
    ...
    @classmethod
    def create(cls: Type[A], data: A) -> A:
        """
    ...
    @classmethod
    def create_many(cls: Type[A], data: list[A]):
        """
    ...
    @classmethod
    def update_many(cls: Type[A], data: list[A]):
        """
        Update multiple documents in the collection

        Args:
            data (List[ArangoBase]): List of data models to be updated

        Returns:
            res (List[ArangoBase]): List of updated data models
        """
    ...
    @classmethod
    def find(cls: Type[A], id_: DocumentID) -> A:
        """
